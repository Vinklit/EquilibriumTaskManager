...
public class SwipeToDelete_other extends ItemTouchHelper.SimpleCallback {
    private TaskAdapter_other otheradapter;
    ColorDrawable background;

    public SwipeToDelete_other(TaskAdapter_other adapter) {
            ...
            new AlertDialog.Builder(viewHolder.itemView.getContext())
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            otheradapter.getItem( position ).cancelTimer();
